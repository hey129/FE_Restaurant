...
<div class="user__right">
    ...
    @if($user!=null)
        ...
        <div class="row user__right--content">
            <div class="col-5 col-xl-3 col-lg-3 col-md-5 col-sm-5 user__right--l">FB</div>
            <div class="col-7 col-xl-9 col-lg-9 col-md-7 col-sm-7 user__ri user__right--r"></div>
        </div>
        <div class="row user__right--content">
