                            ...
                            <form action="admin/about" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-11">
                                        ...
                                        <input type="text" class="form-control" value="{{($about!=null)?$about->linkfb:""}}" name="linkpage"
                                            placeholder="Nhập tiêu đề" required>
                                        <span class="messages"></span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-11">
                                        ...
                                        <input type="text" class="form-control" value="{{($about!=null)?$about->linkcopyright:""}}" name="link"
                                            placeholder="Nhập tiêu đề" required>
                                        <span class="messages"></span>
