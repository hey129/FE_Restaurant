// src/Layout/Components/Order/index.js
...
function Order() {
  ...
  useEffect(() => {
    ...
    async function loadOrders() {
      ...
      try {
        ...
        // Get orders with status: pending, processing, shipping
        const data = await getOrders({
          customerId: user.customer_id,
          statuses: ["pending", "processing", "shipping"],
        });
  ...
  return (
    <div className={cx("container")}>
      <h2 className={cx("title")}>Đơn hàng đang xử lý</h2>
